...
def objectiveXGBRF(trial: Trial, X_tr, y_tr, X_val, y_val):
    params = {
        ...
        'colsample_bynode': trial.suggest_float('colsample_bytree', 0.1, 1),
...
if __name__=='__main__':
    ...
    model_nm = 'xgbrf' # rf, lgbm, xgbrf
    
    save_submission = False
    print(f'Save submission is [{save_submission}]')
    ...
    past_step_grid = [15, 18]#, 15, 18, 21, 24]
